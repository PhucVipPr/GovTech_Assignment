...
public class Service2 extends BaseTest {
    ...
    @Test(dataProvider = "service2")
    public void TC02(String tcid, String requireVerifyBySA, String isSpAutoAssign, String showSlotEndTime,
        ...
        publicService.navigateToLoginPage("https://www.tst.bookingsg.io/public/services/3LywG3yZ/availability?");
        publicService.login();
    ...
    public Object[][] getTestData() throws IOException {
        return ExcelUtils.getTableArray("src/main/resources/TestResult.xlsx","Service2",0,7);
    }
}
